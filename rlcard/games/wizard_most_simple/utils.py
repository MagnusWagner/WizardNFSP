...
from rlcard.games.wizard_most_simple.card import WizardCard as Card

# Read required docs
ROOT_PATH = rlcard.__path__[0]

# a map of abstract action to its index and a list of abstract action
with open(os.path.join(ROOT_PATH, 'games/wizard_most_simple/jsondata/action_space.json'), 'r') as file:
