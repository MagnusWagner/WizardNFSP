...
from rlcard.games.wizard.game import WizardGame as Game
from rlcard.games.wizard.player import WizardPlayer as Player
from rlcard.games.wizard.utils import ACTION_LIST
from rlcard.games.wizard.utils import encode_cards, COLOR_MAP, TRAIT_MAP
...
class TestWizardMethods(unittest.TestCase):
    ...
    def test_get_num_actions(self):
        ...
        self.assertEqual(num_actions, 60)
    ...
    def test_encode_cards(self):
        hand1 = ['r-2','b-wizard',"y-3", 'b-3', 'b-6']
