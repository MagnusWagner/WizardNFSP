...
from rlcard.games.wizard_simple import Game
from rlcard.games.wizard_simple.utils import encode_cards, encode_color
from rlcard.games.wizard_simple.utils import ACTION_SPACE, ACTION_LIST
from rlcard.games.wizard_simple.utils import cards2list
...
class WizardEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.state_shape = [[96+5+1+1+4*self.num_players+1] for _ in range(self.num_players)]  
