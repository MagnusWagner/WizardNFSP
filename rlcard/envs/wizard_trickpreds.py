...
from rlcard.games.wizard_trickpreds.game import WizardGame
from rlcard.games.wizard_trickpreds.utils import encode_cards, encode_color, ACTION_SPACE, ACTION_LIST, cards2list
...
class WizardEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.model_xgb.load_model(f'./rlcard/games/wizard_trickpreds/xgb_models/{self.config["game_num_players"]}P{self.config["game_num_cards"]}C.json')
        ...
        self.state_shape = [[240+5+1+1+4*self.num_players+1+1] for _ in range(self.num_players)]  
