...
from rlcard.agents.human_agents.wizard_s_trickpred_human_agent import _print_state, _print_action


class TestLeducHuman(unittest.TestCase):

    def test_print_state(self):
        raw_state = {'hand': ['r-2','b-wizard',"y-3", 'b-3'],
        'current_player': 0,
        'color_to_play':"g",
        'legal_actions': ['y-3','b-wizard'],
