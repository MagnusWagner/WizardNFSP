...
from rlcard.games.wizard_most_simple import Game
from rlcard.games.wizard_most_simple.utils import encode_cards, encode_color
from rlcard.games.wizard_most_simple.utils import ACTION_SPACE, ACTION_LIST
from rlcard.games.wizard_most_simple.utils import cards2list
...
class WizardEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.state_shape = [[36+5+1+1+4*self.num_players] for _ in range(self.num_players)]  
    ...
    def _extract_state(self, state):
        ...
        obs = np.concatenate((obs,color_to_play,num_cards_left_array,num_actions_left_in_trick_array,players_without_color_array))
