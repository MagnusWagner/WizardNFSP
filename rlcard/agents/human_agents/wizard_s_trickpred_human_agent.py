...
from rlcard.games.wizard_s_trickpreds.card import WizardCard
from rlcard.games.wizard_s_trickpreds.utils import COLOR_MAP_WORDS
...
def _print_state(state, action_record):
    ...
    print('')
    print('=============== Player ',state["current_player"],"'s Turn")
    print(f'=============== P{state["current_player"]} - Tricks left to make: '+str(state['tricks_left_to_get']))
    ...
    print('')
    print('\n======== P',state["current_player"],': Possible actions =========')
