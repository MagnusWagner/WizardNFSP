...
from rlcard.games.wizard_ms_trickpreds.card import WizardCard as Card

# Read required docs
ROOT_PATH = rlcard.__path__[0]

# a map of abstract action to its index and a list of abstract action
with open(os.path.join(ROOT_PATH, 'games/wizard_ms_trickpreds/jsondata/action_space.json'), 'r') as file:
...
TRAIT_MAP = {'1': 0, '2': 1, '3': 2}


def init_deck():
    ''' Generate wizard deck of 12 cards
    '''
    deck = []
    card_info = Card.info
