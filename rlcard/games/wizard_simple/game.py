...
from rlcard.games.wizard_simple import Dealer
from rlcard.games.wizard_simple import Player
from rlcard.games.wizard_simple.utils import COLOR_MAP, getPlayerOrders, cards2list
