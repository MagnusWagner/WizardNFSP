...
from rlcard.games.wizard_ms_trickpreds.game import WizardGame
from rlcard.games.wizard_ms_trickpreds.utils import encode_cards, encode_color, ACTION_SPACE, ACTION_LIST, cards2list
...
class WizardEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.model_xgb.load_model(f'C:/Users/Magnus/Documents/GitHub/rlcard/rlcard/games/wizard_ms_trickpreds/xgb_models/{self.config["game_num_players"]}P{self.config["game_num_cards"]}C.json')
        ...
        self.state_shape = [[36+5+1+1+4*self.num_players+1] for _ in range(self.num_players)] 
    ...
    def _extract_state(self, state):
        ...
        # obs = np.zeros((4, 4, 3), dtype=int) # If we add legal actions.
        ...
        obs = np.concatenate((obs,color_to_play,num_cards_left_array,num_actions_left_in_trick_array,players_without_color_array,tricks_left_to_get))
