...
import pandas as pd
from rlcard.games.wizard_trickpreds import Dealer, Player, Card
from rlcard.games.wizard_trickpreds.utils import COLOR_MAP,COLOR_MAP_WORDS, getPlayerOrders, cards2list, encode_cards, convert_hitscores_to_points
from termcolor import colored

class WizardGame:
    '''
    Sets up a whole game of wizard with 60 cards (all 4 colors with numbers 1 to 13, red is always trump, 4 wizards, 4 fools.)
